...
import { ShieldCheck, Eye, Filter, Clock, Headphones, TrendingUp } from "lucide-react"
...
const features = [
  ...
  },
  {
    icon: Filter,
    title: "Smart Filters",
    description: "Find the perfect property with our advanced filtering options.",
  },
  {
    icon: Clock,
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-zinc-900 md:text-4xl">Your Partner in Finding a Home</h2>
        ...
        <div className="mt-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.title} className="flex flex-col items-center text-center">
              ...
              <h3 className="mt-5 font-semibold text-zinc-900">{feature.title}</h3>
        ...
        <div className="mt-14 text-center">
          <Button className="rounded-full bg-rgb(19, 236, 128) px-8 text-black hover:bg-rgb(19, 236, 128)" asChild>
