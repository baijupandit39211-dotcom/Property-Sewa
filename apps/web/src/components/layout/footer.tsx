  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 py-14">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-black">Property Sewa</span>
            </Link>
            <p className="mt-4 text-sm text-black/80">The modern way to find, buy, and sell your home.</p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-black/20 pt-8 md:flex-row">
          <p className="text-sm text-black/80">© {currentYear} Property Sewa. All rights reserved.</p>
