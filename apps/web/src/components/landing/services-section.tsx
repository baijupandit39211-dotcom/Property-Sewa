import { Home, Key, Heart, Building2, Sparkles } from "lucide-react"
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-zinc-900 md:text-4xl">Everything should be this easy.</h2>
        ...
        <div className="mt-14 grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-5">
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="mt-4 font-semibold text-zinc-900">{service.title}</h3>
