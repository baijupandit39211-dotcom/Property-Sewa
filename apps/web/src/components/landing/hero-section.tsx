...
export function HeroSection() {
	...
	return (
		<section
			...
			style={{
				background:
					"linear-gradient(to right, rgba(22,129,76,1) 0%, rgba(19,236,128,0.1) 100%)",
			}}
		>
			...
			<div className="container relative z-10 mx-auto max-w-7xl px-4 py-16 md:py-24">
				<div className="grid items-center gap-8 lg:grid-cols-6">
					...
					<div className="flex flex-col items-center lg:col-span-3">
						<h1 className="text-center font-bold text-4xl text-white leading-tight md:text-5xl lg:text-6xl">
							The Modern Way to
							<br />
							Find Home
						</h1>
						...
						<div className="mt-6 flex flex-col items-center gap-3">
							<div className="flex flex-wrap justify-center gap-3">
								<Button
									className="rounded-full bg-emerald-600 px-6 text-black hover:bg-emerald-700"
									size="lg"
									asChild
								>
							...
							<Link
								href="/neighborhoods"
								className="inline-flex items-center gap-2 font-medium text-sm text-white hover:underline"
							>
