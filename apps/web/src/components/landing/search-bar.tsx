...
export function SearchBar() {
  ...
  return (
    <div className="w-full max-w-xl">
      ...
      <div className="flex overflow-hidden rounded-t-2xl bg-zinc-100">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex-1 px-8 py-3 text-sm font-medium transition-colors ${
              activeTab === tab.value ? "bg-white text-zinc-900" : "bg-zinc-100 text-zinc-500 hover:text-zinc-700"
            }`}
          >
            {tab.label}
          </button>
      ...
      {/* Search Form Card */}
      <form onSubmit={handleSearch} className="rounded-b-2xl bg-white p-5 shadow-xl">
        ...
        <div className="relative mb-4 flex items-center rounded-lg border border-zinc-200 bg-white">
          ...
          <Button
            type="submit"
            className="m-1 rounded-lg bg-emerald-500 px-5 text-sm font-medium text-white hover:bg-emerald-600"
          >
