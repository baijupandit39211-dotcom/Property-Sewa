...
export default function SellerLeadDetailPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch lead details
        const leadResponse = await apiFetch<{ success: boolean; items: Lead[] }>("/leads/mine");
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm text-slate-600">Original Message</p>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`text-xs mt-1 ${
                          message.senderRole === "seller" ? "text-emerald-100" : "text-slate-500"
                        }`}>
