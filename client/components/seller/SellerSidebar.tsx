...
export default function SellerSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={[
          "fixed left-0 top-14 z-50 flex h-[calc(100dvh-56px)] w-64 flex-col border-r border-slate-200 bg-white shadow-[0_24px_48px_rgba(15,23,42,0.14)] transition-transform duration-300 ease-out lg:z-30 lg:translate-x-0",
